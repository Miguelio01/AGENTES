...
export type SessionFlowState = 
  ...
  | 'READY_FOR_DELIVERY'
  | 'TELEGRAM_AWAITING_CLIENT_NAME'
  | 'TELEGRAM_AWAITING_CLIENT_PHONE'
  | 'TELEGRAM_AWAITING_CLIENT_DOC_TYPE'
  | 'TELEGRAM_AWAITING_CLIENT_DOC_NUMBER'
  | 'TELEGRAM_AWAITING_CLIENT_ADDRESS'
  | 'TELEGRAM_AWAITING_CLIENT_EMAIL'
  | 'TELEGRAM_AWAITING_ORDER_ITEMS'
  | 'TELEGRAM_AWAITING_DELIVERY_CHOICE'
  | 'COMPLETED';
